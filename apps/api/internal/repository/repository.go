...
type PCIRepository interface {
	...
	BindDeviceToVFIO(ctx context.Context, pciAddr string) error
	UnbindDeviceFromVFIO(ctx context.Context, pciAddr string) error
}
...
type ProxyRepository interface {
	...
	ListByTargetIP(ctx context.Context, ip string) ([]*model.ProxyHost, error)
