...
export function useStoragePoolMutations({ onCreateSuccess, onDeleteSuccess, onUpdateSuccess }: UseStoragePoolMutationsOptions = {}) {
  const queryClient = useQueryClient()

  const createPool = useMutation({
    mutationFn: (data: Parameters<typeof storageClient.createStoragePool>[0]) => storageClient.createStoragePool(data),
    onSuccess: () => {
  ...
  const updatePool = useMutation({
    mutationFn: (data: Parameters<typeof storageClient.updateStoragePool>[0]) => storageClient.updateStoragePool(data),
    onSuccess: () => {
  ...
  const deletePool = useMutation({
    mutationFn: ({ id, force }: { id: string; force?: boolean }) => storageClient.deleteStoragePool({ id, force }),
    onSuccess: () => {
...
export function useStorageDiskMutations({ onCreateSuccess, onDeleteSuccess }: UseStorageDiskMutationsOptions = {}) {
  const queryClient = useQueryClient()

  const createDisk = useMutation({
    mutationFn: (data: Parameters<typeof storageClient.createStorageDisk>[0]) => storageClient.createStorageDisk(data),
    onSuccess: () => {
  ...
  const resizeDisk = useMutation({
    mutationFn: (data: Parameters<typeof storageClient.resizeStorageDisk>[0]) => storageClient.resizeStorageDisk(data),
    onSuccess: () => {
  ...
  const deleteDisk = useMutation({
    mutationFn: ({ diskId, purge }: { diskId: string; purge?: boolean }) => storageClient.deleteStorageDisk({ diskId, purge }),
    onSuccess: () => {
  ...
  const moveDisk = useMutation({
    mutationFn: (data: Parameters<typeof storageClient.moveStorageDisk>[0]) => storageClient.moveStorageDisk(data),
    onSuccess: () => {
...
export function useVMDiskMutations(vmid: number) {
  ...
  const attachDisk = useMutation({
    mutationFn: (data: Parameters<typeof storageClient.attachVMdisk>[0]) => storageClient.attachVMdisk(data),
    onSuccess: () => {
  ...
  const detachDisk = useMutation({
    mutationFn: (data: Parameters<typeof storageClient.detachVMdisk>[0]) => storageClient.detachVMdisk(data),
    onSuccess: () => {
  ...
  const resizeDisk = useMutation({
    mutationFn: (data: Parameters<typeof storageClient.resizeVMdisk>[0]) => storageClient.resizeVMdisk(data),
    onSuccess: () => {
