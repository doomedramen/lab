...
export function useNetworkMutations({
  ...
  onDeleteSuccess,
  onUpdateSuccess,
}: UseNetworkMutationsOptions = {}) {
  const queryClient = useQueryClient();

  const createNetwork = useMutation({
    mutationFn: (data: Parameters<typeof networkClient.createNetwork>[0]) =>
      networkClient.createNetwork(data),
    onSuccess: () => {
  ...
  const updateNetwork = useMutation({
    mutationFn: (data: Parameters<typeof networkClient.updateNetwork>[0]) =>
      networkClient.updateNetwork(data),
    onSuccess: () => {
  ...
  const deleteNetwork = useMutation({
    mutationFn: ({ id, force }: { id: string; force?: boolean }) =>
      networkClient.deleteNetwork({ id, force }),
    onSuccess: () => {
  ...
  const createInterface = useMutation({
    mutationFn: (
      data: Parameters<typeof networkClient.createVmNetworkInterface>[0],
    ) => networkClient.createVmNetworkInterface(data),
    onSuccess: () => {
  ...
  const updateInterface = useMutation({
    mutationFn: (
      data: Parameters<typeof networkClient.updateVmNetworkInterface>[0],
    ) => networkClient.updateVmNetworkInterface(data),
    onSuccess: () => {
  ...
  const createBridge = useMutation({
    mutationFn: (data: Parameters<typeof networkClient.createBridge>[0]) =>
      networkClient.createBridge(data),
    onSuccess: () => {
  ...
  const deleteBridge = useMutation({
    mutationFn: ({ name, force }: { name: string; force?: boolean }) =>
      networkClient.deleteBridge({ name, force }),
    onSuccess: () => {
...
export function useFirewallMutations({
  onCreateSuccess,
  onDeleteSuccess,
  onUpdateSuccess,
}: UseFirewallMutationsOptions = {}) {
  const queryClient = useQueryClient();

  const createRule = useMutation({
    mutationFn: (
      data: Parameters<typeof firewallClient.createFirewallRule>[0],
    ) => firewallClient.createFirewallRule(data),
    onSuccess: () => {
  ...
  const updateRule = useMutation({
    mutationFn: (
      data: Parameters<typeof firewallClient.updateFirewallRule>[0],
    ) => firewallClient.updateFirewallRule(data),
    onSuccess: () => {
  ...
  const disableFirewall = useMutation({
    mutationFn: ({
      ...
      firewallClient.disableFirewall({
        scopeType: scopeType ?? "",
        scopeId: scopeId ?? "",
      }),
    onSuccess: () => {
