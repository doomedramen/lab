...
export interface AuthContextType {
  ...
  setupMFA: () => Promise<{ secret: string; qrCodeUrl: string; manualKey: string; backupCodes: string[] }>
  enableMFA: (mfaCode: string) => Promise<void>
  disableMFA: (mfaCode: string) => Promise<void>
  createAPIKey: (name: string, permissions: string[], expiresAt?: string) => Promise<void>
