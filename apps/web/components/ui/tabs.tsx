...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      ...
      className={cn(
        "gap-2 group/tabs flex data-horizontal:flex-col flex-col",
        className,
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:border-border data-[state=active]:shadow-sm dark:data-[state=active]:bg-card dark:data-[state=active]:border-border dark:data-[state=active]:text-foreground",
