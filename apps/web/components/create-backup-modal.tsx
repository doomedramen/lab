...
export function CreateBackupModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    createBackup.mutate({
      ...
      name:
        name.trim() ||
        `Backup-${vmid}-${new Date().toISOString().split("T")[0]}`,
      type: backupType,
      storagePool,
      compress,
      retentionDays,
      ...
      <DialogContent className="sm:max-w-[500px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Create a backup of {vmName}. Backups can be restored to the same
              or different VM.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select
                ...
                onValueChange={(v) => setBackupType(Number(v) as BackupType)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
