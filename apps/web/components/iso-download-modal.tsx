...
export function ISODownloadModal({
  ...
  const handleSubmit = () => {
    ...
    const finalFilename =
      filename.trim() || url.trim().split("/").pop() || "downloaded.iso";
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent data-testid="iso-download-modal" className="max-w-lg">
        <DialogHeader>
          <DialogTitle data-testid="iso-download-modal-title">
            Download ISO Image
          </DialogTitle>
          <DialogDescription data-testid="iso-download-modal-description">
            Download an ISO image from a URL. The ISO will be downloaded in the
            background and will be available for VM creation once complete.
          </DialogDescription>
        </DialogHeader>
