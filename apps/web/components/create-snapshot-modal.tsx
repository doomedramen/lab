...
export function CreateSnapshotModal({ vmid, vmName, vmState, trigger, onSuccess }: CreateSnapshotModalProps) {
      ...
      <DialogContent className="sm:max-w-[500px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Create a point-in-time snapshot of {vmName}. Snapshots capture the disk state and optionally memory.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <Label htmlFor="snapshot-live" className="cursor-pointer">
                          Live Snapshot
                        </Label>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <Label htmlFor="snapshot-memory" className="cursor-pointer">
                          Include Memory
                        </Label>
                        <p className="text-xs text-muted-foreground">
            ...
            {!isVMRunning && (
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>VM is stopped. Snapshot will capture disk state only.</span>
              </div>
            )}
          </div>
