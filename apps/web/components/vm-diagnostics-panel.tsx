...
export function VMDiagnosticsPanel({
  vmid,
  data,
  onRefresh,
  isLoading,
}: VMDiagnosticsPanelProps) {
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Badge
              variant={data.info?.state === "running" ? "default" : "secondary"}
            >
      ...
      <Tabs defaultValue="overview" className="w-full">
            ...
            <CardContent className="space-y-2">
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <div>
                  <Badge
                    variant={
                      data.info?.state === "running" ? "default" : "secondary"
                    }
                  >
                    {data.info?.state}
                  </Badge>
            ...
            <CardContent>
              {data.networkInterfaces && data.networkInterfaces.length > 0 ? (
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    No network interfaces detected. This is normal for VMs using
                    user-mode (NAT) networking or without QEMU guest agent
                    installed.
                  </AlertDescription>
                </Alert>
              )}
        ...
        <TabsContent value="console">
          <Card>
            ...
            <CardContent>
              {data.qemuMonitor?.charDevices &&
              data.qemuMonitor.charDevices.length > 0 ? (
                <div className="space-y-2">
