...
export function EntityActionButtons({
  ...
  return (
    <div
      ...
      data-testid="entity-action-buttons"
    >
      {isRunning && (
        <>
          {variant === "vm" && (
          ...
          {variant === "vm" && (
            <Button
              ...
              data-testid="vm-shutdown-button"
            >
              {loading?.shutdown ? (
                <Loader2 className="size-3.5 animate-spin" />
              ) : (
      ...
      <ButtonGroup className="gap-0">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            ...
            <DropdownMenuItem
              disabled
              onClick={() => handleConsoleTypeSelect("websockify")}
            >
              <Terminal className="size-4 mr-2" />
              websockify
            </DropdownMenuItem>
