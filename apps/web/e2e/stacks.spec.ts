...
test.describe("Stacks — list page", () => {
  test("renders stacks page title and create button", async ({
    gotoStacks,
    page,
  }) => {
    await gotoStacks();
...
test.describe("Stacks — create modal", () => {
  test("opens create stack modal on button click", async ({
    gotoStacks,
    page,
  }) => {
    await gotoStacks();
  ...
  test("shows validation error for names with invalid characters", async ({
    gotoStacks,
    page,
  }) => {
    await gotoStacks();
  ...
  test("env tab shows Monaco editor when clicked", async ({
    gotoStacks,
    page,
  }) => {
    await gotoStacks();
  ...
  test("cancel button closes modal without navigating", async ({
    gotoStacks,
    page,
  }) => {
    await gotoStacks();
...
test.describe("Stacks — create and detail page", () => {
  ...
  test("creating a stack navigates to detail page with correct name", async ({
    page,
    gotoStacks,
  }) => {
    ...
    const stackCard = page
      .locator('[data-testid^="stack-card-"]')
    ...
    await expect(page.getByTestId("stack-detail-name")).toContainText(
      stackName,
    );
  ...
  test("detail page shows all action buttons", async ({
    createStack,
    page,
  }) => {
    createdStackId = await createStack();
  ...
  test("compose tab renders Monaco editor with YAML content", async ({
    createStack,
    page,
  }) => {
    createdStackId = await createStack();
  ...
  test("created stack appears in the stacks list", async ({
    createStack,
    page,
  }) => {
...
test.describe("Stacks — lifecycle: start, stop, delete", () => {
  ...
  test("start → running → stop → stopped → delete", async ({
    createStack,
    page,
  }) => {
    createdStackId = await createStack();
  ...
  test("restart button is visible when stack is running", async ({
    createStack,
    page,
  }) => {
    createdStackId = await createStack();
...
test.describe("Stacks — confirmation dialogs", () => {
  ...
  test("down dialog: cancel keeps stack unchanged", async ({
    createStack,
    page,
  }) => {
    createdStackId = await createStack();
  ...
  test("down dialog contains informative description", async ({
    createStack,
    page,
  }) => {
    createdStackId = await createStack();
  ...
  test("delete dialog: cancel keeps stack unchanged", async ({
    createStack,
    page,
  }) => {
    createdStackId = await createStack();
  ...
  test("delete dialog contains permanent-deletion warning", async ({
    createStack,
    page,
  }) => {
    createdStackId = await createStack();
  ...
  test("deleting a stack redirects to the stacks list", async ({
    createStack,
    page,
  }) => {
    createdStackId = await createStack();
...
test.describe("Stacks — compose and env editing", () => {
  ...
  test("compose tab has a Save Compose button", async ({
    createStack,
    page,
  }) => {
    createdStackId = await createStack();
    ...
    await page.getByRole("tab", { name: /docker-compose/i }).click();
    await expect(
      page.getByRole("button", { name: /save compose/i }),
    ).toBeVisible();
  });
